...
<?php
    ...
    <header class="d-flex flex-row justify-content-between align-items-center w-100 px-2">
            <a href="/index.php" class="nav-a px-3 d-flex align-items-center"> <i class="fa-solid fa-caret-left pe-2 fs-1"></i> Назад</a>
        ...
        <nav class="d-flex flex-column align-items-center w-100">
            <a href="/pages/class.php?thisDepId=<?=$_GET['thisDepId'] ?>" class="nav-a w-50">Расписание занятий</a>
            <a href="/pages/bells.php?thisDepId=<?=$_GET['thisDepId'] ?>" class="nav-a w-50">Расписание звонков</a>
            <a href="/pages/adds.php?thisDepId=<?=$_GET['thisDepId'] ?>" class="nav-a w-50">Объявления</a>
        </nav>
    </main>
